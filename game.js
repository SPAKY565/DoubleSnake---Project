...
console.log("varSnake")

  const INITIAL_TAIL = 4;
  var fixedTail = true;
  
  console.log("const inital_trail = 4")
  console.log("var fixedtail = true")
  ...
  console.log("var titlecount = 10 and grid size = 400 / title count")
  ...
  function setup () {
    ...
    game.reset();
    console.log("game reset func True")
  }
  ...
  var game = {
    ...
    reset: function () {
      ...
      console.log("game reset / restarted")
    ...
    RandomFruit: function () {
      if(walls){
        ...
        console.log("fruit getted and new fruit generated!");
      }
      else {
